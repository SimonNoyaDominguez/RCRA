  ...
  for model in handle:
      for atom in model.symbols(atoms=True):
          ...
          and len(atom.arguments)==2):
              tipo_argumento1 = type(atom.arguments[0])
              tipo_argumento2 = type(atom.arguments[1])
              #print("El primer argumento es:", atom.arguments[0])
              #print("El segundo argumento es:", atom.arguments[1]) 
              #print("El tipo de dato del primer argumento es:", tipo_argumento1)
              #print("El tipo de dato del segundo argumento es:", tipo_argumento2) 
